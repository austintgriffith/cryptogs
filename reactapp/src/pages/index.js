              ...
              <section className="section pt-5 pb-5 text-center">
                  <div className="container">
                      ...
                      <BuyPacks compact={true} />
							...
							<section className="section background-primary pt-5 pb-5">
									<div className="container">
											<h1 className="h2 mb-5 text-center">Meet the Team from <a href="https://ethdenver.com/" target="_blank">#ETHDenver</a></h1>
																		...
																		<div className="d-flex justify-content-center mb-3">
																				<div style={{position: 'relative',marginLeft:25}}>
																					<Spinner key={"spinner1"} guts={
																						(spinning)=>{
																							return (
																								<Cryptog key={"cryptogaustin"} id={0} scale={1.2} slowrolling={spinning} image={"austingriffith.jpg"}/>
																							)
																						}
																					}/>
																			 </div>
																		</div>
																		<p className="text-center" style={{fontWeight:'bold'}}>Austin Thomas Griffith</p>
																		<p className="text-center">Smart Contracts - Game Design - Front End</p>
																		<p className="text-center">
																			<a target="_blank" href="https://austingriffith.com"> Website</a> -
																			<a target="_blank" href="https://www.facebook.com/austin.griffith"> Facebook</a> -
																			<a target="_blank" href="https://twitter.com/austingriffith"> Twitter</a>
																...
																<div className="d-flex justify-content-center mb-3">
																	<div style={{position: 'relative',marginLeft:25}}>
																		<Spinner key={"spinner1"} guts={
																			(spinning)=>{
																				return (
																					<Cryptog key={"cryptogjon"} id={0} scale={1.2} slowrolling={spinning} image={"jonathangorczyca.jpg"}/>
																				)
																			}
																		}/>
																 </div>
															</div>
															<p className="text-center" style={{fontWeight:'bold'}}>Jonathan Gorczyca</p>
															<p className="text-center">Mobile Prototype - Logo Design - Pog Design</p>
															<p className="text-center">
																<a target="_blank" href="https://twitter.com/watch84"> Twitter</a> -
																<a target="_blank" href="https://www.linkedin.com/in/jonathangorczyca/"> Linkedin</a>
															</p>
															</div>
																...
																<div className="d-flex justify-content-center mb-3">
																		<div style={{position: 'relative',marginLeft:25}}>
																			<Spinner key={"spinner1"} guts={
																				(spinning)=>{
																					return (
																						<Cryptog key={"cryptogKaren"} id={0} scale={1.2} slowrolling={spinning} image={"karenscarbrough.jpg"}/>
																					)
																				}
																			}/>
																	 </div>
																</div>
																<p className="text-center" style={{fontWeight:'bold'}}>Karen Scarbrough</p>
																<p className="text-center">Smart Contract Support - Game Play QA</p>
																<p className="text-center">
																	<a target="_blank" href="https://twitter.com/kds0718"> Twitter</a>
																</p>
																...
																<div className="d-flex justify-content-center mb-3">
																		<div style={{position: 'relative',marginLeft:25}}>
																			<Spinner key={"spinner1"} guts={
																				(spinning)=>{
																					return (
																						<Cryptog key={"cryptogKaren"} id={0} scale={1.2} slowrolling={spinning} image={"patrickmackay.jpg"}/>
																					)
																				}
																			}/>
																	 </div>
																</div>
																<p className="text-center" style={{fontWeight:'bold'}}>Patrick Mackay</p>
																<p className="text-center">Game Play QA - All Around Cryptog</p>
																<p className="text-center">
																	<a target="_blank" href="https://twitter.com/PatrickDMackay"> Twitter</a>
																</p>
															</div>
							...
							<section className="section text-center" style={{paddingTop:140, paddingBottom: 130}}>
								<div className="container text-center">
									<p><a className="btn btn-blue btn-lg btn--alt" href="/contracts">View Contracts</a></p>
								</div>
							</section>
