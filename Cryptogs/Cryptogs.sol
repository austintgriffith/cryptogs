...
contract Cryptogs is NFT, Ownable {
    ...
    uint8 public constant FLIPPINESS = 99;
    ...
    function submitStack(address _slammerTime, uint256 _id,uint256 _id2,uint256 _id3,uint256 _id4,uint256 _id5, bool _public) public returns (bool) {
      ...
      SubmitStack(msg.sender,stackid,_id,_id2,_id3,_id4,_id5,_public);
    }
    event SubmitStack(address _sender,bytes32 _stackid,uint256 _token1,uint256 _token2,uint256 _token3,uint256 _token4,uint256 _token5,bool _public);
    ...
    function submitCounterStack(address _slammerTime, bytes32 _stack, uint256 _id, uint256 _id2, uint256 _id3, uint256 _id4, uint256 _id5) public returns (bool) {
      ...
      //the event is triggered to the frontend to display the stack
      //the frontend will check if they want it public or not
      CounterStack(msg.sender,_stack,stackid,_id,_id2,_id3,_id4,_id5);
    }
    event CounterStack(address _sender,bytes32 _stack, bytes32 _counterStack, uint256 _token1, uint256 _token2, uint256 _token3, uint256 _token4, uint256 _token5);
